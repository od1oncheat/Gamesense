...
Main.Size = UDim2.new(0, 750, 0, 650) -- Увеличена высота панели
Tabs.Name = "Tabs"
Tabs.Parent = Main
...
Tabs.Size = UDim2.new(0, 110, 0, 647) -- Увеличены кнопки табов по X
...
Content.Size = UDim2.new(0, 620, 0, 624) -- Увеличена высота контента
...
Sector.Size = UDim2.new(0.5, -15, 0.93, 0) -- Добавлены отступы по бокам
...
SectorContent.Size = UDim2.new(0, 275, 0, 545) -- Увеличена высота контента
...
Bg.Position = UDim2.new(0, 8, 0.324999988, 0) -- Уменьшен отступ слева
...
Slider.Size = UDim2.new(1, 0, 0, 25) -- Занимает всю ширину
...
Bg.BorderColor3 = themes[theme]["ElementOutline"]
Bg.Position = UDim2.new(0.05, 0, 0.72, 0) -- Уменьшен отступ слева
