...
UIGridLayout.CellSize = UDim2.new(0, 110, 0, 70)
...
local labelPosX = math.clamp(fraction, 0.02, 0.98)
ValueLabel.Position = UDim2.new(labelPosX, 0, 0.85, 0)
end
slider.get = function()
return value
end
