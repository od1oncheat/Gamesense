...
Main.Size = UDim2.new(0, 750, 0, 680) -- Увеличена высота панели
Tabs.Name = "Tabs"
Tabs.Parent = Main
...
Tabs.Size = UDim2.new(0, 110, 0, 677) -- Увеличены кнопки табов по X
UIGridLayout.Parent = Tabs
UIGridLayout.SortOrder = Enum.SortOrder.LayoutOrder
UIGridLayout.CellPadding = UDim2.new(0, 15, 0, 0)
UIGridLayout.CellSize = UDim2.new(0, 105, 0, 70) -- Увеличен размер ячеек
...
Content.Position = UDim2.new(0.16, 0, 0.0247933883, 0) -- Сдвинуто влево
Content.Size = UDim2.new(0, 620, 0, 654) -- Увеличена высота контента
...
Tab.Size = UDim2.new(0, 105, 0, 70) -- Увеличен размер кнопки таба
...
Sector.Size = UDim2.new(0.5, -15, 0.95, 0) -- Увеличена высота сектора
...
Title.Position = UDim2.new(0.05, 0, -0.0120898103, 0) -- Увеличен отступ слева
...
SectorContent.Position = UDim2.new(0.05, 0, 0.04, 0) -- Увеличен отступ слева
SectorContent.Size = UDim2.new(0, 275, 0, 575) -- Увеличена высота контента
SectorContent.CanvasSize = UDim2.new(0, 0, 0, 0)
SectorContent.ScrollBarThickness = 3
UIListLayout.Parent = SectorContent
UIListLayout.SortOrder = Enum.SortOrder.LayoutOrder
UIListLayout.Padding = UDim.new(0,12) -- Увеличен отступ между элементами
...
UIPad.Parent = Text
UIPad.PaddingLeft = UDim.new(0, 15) -- Уменьшен отступ для текста
...
TextBox.Size = UDim2.new(1, 0, 0, 25) -- Занимает всю ширину с учетом отступов
...
Button.Size = UDim2.new(1, 0, 0, 25) -- Занимает всю ширину с учетом отступов
...
Dropdown.Size = UDim2.new(1, 0, 0, 25) -- Занимает всю ширину с учетом отступов
...
DropdownContent.Size = UDim2.new(1, 0, 0, 116) -- Занимает всю ширину
...
Button.BackgroundColor3 = themes[theme]["ElementBg"]
Button.BorderColor3 = themes[theme]["ElementOutline"]
Button.Size = UDim2.new(1, -10, 0, 25) -- Занимает всю ширину с небольшим отступом
Button.Font = Enum.Font.Gotham
Button.TextColor3 = themes[theme]["Text"]
Button.TextSize = 14.000
Button.Text = name
...
Toggle.Size = UDim2.new(1, 0, 0, 18) -- Занимает всю ширину
...
Text.BorderColor3 = Color3.fromRGB(0, 0, 0)
Text.BorderSizePixel = 0
Text.Position = UDim2.new(0.12, 0, 0, 0) -- Сдвинут текст правее, чтобы не налазил на чекбокс
...
Bg.Position = UDim2.new(0, 8, 0.324999988, 0) -- Чекбокс сдвинут левее
...
Colorpicker.Position = UDim2.new(0.92, 0, 0.325, 0)
Colorpicker.Size = UDim2.new(0, 22, 0, 9)
...
Slider.Size = UDim2.new(1, 0, 0, 30) -- Увеличен размер слайдера
...
Text.BorderColor3 = Color3.fromRGB(0, 0, 0)
Text.BorderSizePixel = 0
Text.Position = UDim2.new(0.05, 0, 0, 0) -- Уменьшен отступ слева
Text.Size = UDim2.new(0, 226, 0, 18)
Text.Font = Enum.Font.Gotham
Text.TextColor3 = themes[theme]["Text"]
Text.TextSize = 14.000
...
Bg.BorderColor3 = themes[theme]["ElementOutline"]
Bg.Position = UDim2.new(0.05, 0, 0.6, 0) -- Сдвинут ниже
Bg.Size = UDim2.new(0.9, 0, 0, 8) -- Занимает 90% ширины с отступами
Bg.AutoButtonColor = false
Bg.Font = Enum.Font.Gotham
Bg.Text = ""
Bg.TextColor3 = Color3.fromRGB(0, 0, 0)
...
callback(value)
local displayValue = tostring(math.round(value * 100) / 100)..indicator
ValueLabel.Text = displayValue
-- Фиксация позиции значения слайдера, чтобы не выходило за пределы
local bgAbsPos = Bg.AbsolutePosition.X
local bgAbsSize = Bg.AbsoluteSize.X
local fillAbsSize = bgAbsSize * fraction
local labelPos = math.clamp(fillAbsSize, 30, bgAbsSize - 30) -- Ограничение позиции метки
