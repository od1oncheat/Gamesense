...
WatermarkPattern.Image = "rbxassetid://0"
...
SectorContent.Position = UDim2.new(0, 0, 0, 30)
SectorContent.Size = UDim2.new(1, 0, 1, -30)
...
sector.dropdown = function(text, options, default, callback)
    ...
    Image.Position = UDim2.new(1, -20, 0.142857149, 0)
